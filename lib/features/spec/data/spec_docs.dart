...
const manualDoc = Doc('软件使用手册', [
  ...
  DocSection('五个主标签', [
    ...
    '我：API Provider、采样预设、助手、制作规范、使用手册、备份恢复、检查更新。',
  ]),
  DocSection('导入角色', [
    '联系人 → 导入角色：支持 PNG / JSON 角色卡与 Skill（ZIP / Markdown），可批量多选。',
  ...
  DocSection('单聊 / 群聊 / 剧情', [
    '单聊：SSE 流式回复，支持开场白切换（←/🎲/→）、撤回消息、会话设置（采样参数/预设/世界书选择）。',
    '群聊：多角色 + 三种发言模式（auto 自动 / turn 轮流 / call 点名@角色）。',
    '剧情：AI 生成 + 分支树 + 回退 + 存档。',
  ]),
  DocSection('记忆与斜杠指令', [
    '每轮回复后异步抽取「结构化状态 + 滚动摘要」，按「角色 × 世界」隔离。',
    '/status 当前状态 · /relation 关系 · /summary 摘要 · /lore 世界书 · /mode 群聊模式 · /help 帮助。',
  ]),
  DocSection('备份与更新', [
